...
const HeroSection = () => {
    return (
        ...
        <div className="relative min-h-[calc(100vh-3.9rem)] flex flex-col items-center justify-center px-4 overflow-hidden">
            ...
            >
                <h1 className="bg-clip-text text-transparent bg-gradient-to-r from-[#0078ff] via-[#00a2ff] to-[#0099ff] text-6xl md:text-7xl lg:text-8xl font-bold tracking-tight drop-shadow-lg">
                    Project Expo
                </h1>
