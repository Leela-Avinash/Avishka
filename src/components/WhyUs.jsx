    ...
    return (
        <div className="flex justify-center md:items-start lg:items-center flex-col md:flex-row items-center gap-10 my-5 mx-5 ">
            ...
            >
                ...
                >
                    <div className="bg-[rgba(30,30,30,0.5)] py-4 backdrop-blur-md border-gray-800 absolute w-full h-full text-gray-800 rounded-lg backface-hidden transform rotate-y-180 overflow-hidden flex flex-col justify-center items-center gap-5 hover:shadow-[0_0_15px_rgba(106,90,205,0.3)] text-muted-foreground">
                        <div
            ...
            >
                {cards.map((card, i) => {
                    ...
                    return (
                        <div
                            key={i}
                            className="w-full lg:w-60 md:w-64 h-52 perspective"
                        >
                            <div
                                className={`relative w-full h-full transition-transform duration-700 transform`}
                                onMouseMove={(event) =>
                            ...
                            >
                                <div className="bg-[rgba(30,30,30,0.5)] py-4 backdrop-blur-md border-gray-800 absolute w-full h-full text-gray-800 rounded-lg backface-hidden transform rotate-y-180 overflow-hidden flex flex-col justify-center items-center gap-5 hover:shadow-[0_0_15px_rgba(106,90,205,0.3)] text-muted-foreground">
                                    ...
                                    />
                                    <div className="p-2 rounded-full bg-gradient-to-r from-purple-400 to-blue-500 text-white">
                                        {card.Icon}
                                    </div>
                                    <p className="text-sm px-8 text-center mt-2">
                                        {card.Description}
